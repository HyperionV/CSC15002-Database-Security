...
from employee_management import EmployeeManagementScreen
...
class Application:
    ...
    def _create_navigation(self):
        ...
        self.employee_button = ttk.Button(
            self.nav_frame,
            text="Quản lý Nhân Viên",
            command=lambda: self._show_screen('employee')
        )
        self.employee_button.pack(side=tk.LEFT, padx=5)
    ...
    def _create_screen(self, name):
        ...
        if name == 'class':
            ...
            screen = EmployeeManagementScreen(self.content_frame)
            self.screens[name] = screen
            screen.pack(fill=tk.BOTH, expand=True)
            screen.pack_forget()  # Initially hidden
    ...
    def _on_login_success(self):
        ...
        # Show the employee management screen by default
        self._show_screen('employee')
